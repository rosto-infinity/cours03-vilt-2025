...
<template>
  <div>
    ...
    <SecondaryButton @click="openDeleteModal" class="bg-red-500 hover:bg-red-700 text-white p-1 rounded-md">
    ...
    <Modal :show="confirmingDelete" @close="closeDeleteModal">
      <div class="p-6">
        ...
        <div class="flex justify-end space-x-3">
          <SecondaryButton @click="closeDeleteModal" class="bg-gray-500 hover:bg-gray-700 text-white">
            Annuler
          </SecondaryButton>
          <PrimaryButton @click="deleteNiveauScolaire" class="bg-red-500 hover:bg-red-700 text-white">
            Supprimer
          </PrimaryButton>
        </div>
      </div>
